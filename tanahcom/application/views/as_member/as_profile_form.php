...
<html>
  ...
  <div class="container">
    <div class="header__main">
      <div class="header__logo">
        <a href="index.html">
          ...
          <img src="<?php echo base_url();?>images/tanah-logo.png" width="100" alt="tanah.com">
        </a>
      </div><!-- .header__logo -->
	...
	<h2>Hai, <?php echo $this->session->userdata('member_fullname'); ?></h2>
	<a href="<?php echo base_url('as_member/logout'); ?>">Logout</a>
...
<section class="sign-up">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Signup</span></li>
        </ul><!-- .ht-breadcrumb -->
