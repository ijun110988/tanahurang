<!doctype html>
<?php
$session_data = $this->session->userdata('member_status');
?>
<html>
    <head>
					...
					<?php
                       ...
                       <form action="<?php echo base_url('login'); ?>" method="post">
                            <fieldset>
                                ...
                                <button type="submit" name="submit" id="submit" value="Log In" class="btn btn-lg btn-success btn-block">Login</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
