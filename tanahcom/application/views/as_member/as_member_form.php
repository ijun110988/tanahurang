...
<section class="sign-up">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Register</span></li>
        </ul><!-- .ht-breadcrumb -->
                    ...
                    <div class="panel-body">
						...
						<form action="<?php echo $action; ?>" method="post">
							<div class="form-group">
								<label for="sign-up-email" class="sign-up__label">Full Name <?php echo form_error('member_fullname') ?></label>
								 <input type="text" class="sign-up__field"  name="member_fullname"placeholder="Member Fullname" value="<?php echo $member_fullname; ?>">
							</div>
							
							
							<div class="form-group">
								 <label for="sign-up-email" class="sign-up__label">Member email<?php echo form_error('member_email') ?></label>
								<input type="email" class="sign-up__field"  name="member_email" id="member_email" placeholder="Member Email" value="<?php echo $member_email; ?>" />
							
							</div>
							
	                       <div class="form-group">
								<label for="sign-up-email" class="sign-up__label">Member Username <?php echo form_error('member_username') ?></label>
								<input type="text" class="form-control" name="member_username" id="member_username" placeholder="Member Username" value="<?php echo $member_username; ?>" />
							</div>
							<div class="form-group">
								<label for="sign-up-password" class="sign-up__label">Member Password <?php echo form_error('member_password') ?></label>
								<input type="password" class="sign-up__field"   name="member_password" id="member_password" placeholder="Member Password" value="<?php echo $member_password; ?>" />
							</div>
						<div class="form-group">
							
							<input type="hidden" class="form-control" name="member_photo" id="member_photo" placeholder="Member Photo" value="member_photo" />
						</div>
						<div class="form-group">
							<input type="hidden" class="form-control" name="member_province" id="member_province" placeholder="Member Province" value="member_province" />
						</div>
						<div class="form-group">
							
							<input type="hidden" class="form-control" name="member_city" id="member_city" placeholder="Member City" value="member_city" />
						</div>
						<div class="form-group">
														<input type="hidden" class="form-control" name="member_chellphone" id="member_chellphone" placeholder="Member Chellphone" value="member_chellphone" />
						</div>
						<div class="form-group">
							
							<input type="hidden" class="form-control" name="memner_address" id="memner_address" placeholder="Memner Address" value="emner_address" />
						</div>
						<div class="form-group">
							
							<input type="hidden" class="form-control" name="member_status" id="member_status" placeholder="Member Status" value="member_status" />
						</div>
						<div class="form-group">
							<input type="hidden" class="form-control" name="member_level" id="member_level" placeholder="Member Level" value="member_level" />
						</div>
						<div class="form-group">
							<input type="hidden" class="form-control" name="member_blokir" id="member_blokir" placeholder="Member Blokir" value="member_blokir" />
						</div>
						<input type="hidden" name="member_id" value="<?php echo $member_id; ?>" /> 
						<button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
						<!--<a href="<?php echo site_url('as_member') ?>" class="btn btn-default">Cancel</a>-->		
...
<section class="newsletter">
  <?php $this->load->view('content/subcribe') ?>
</section><!-- .newsletter -->
