        ...
        <div class="my-profile__container">
            <div class="row">
                ...
                <form action="">
                    <div class="col-md-4">
						<?php $login_data =$this->session->userdata("login"); ?>
			            <label for="profile-first-name" class="my-profile__label">Fullname</label>
                        <input type="text" value="<?php echo $login_data['fullname'] ?> " class="my-profile__field" id="profile-first-name">
					

                        <label for="profile-last-name" class="my-profile__label">Email</label>
                        <input type="text" value="<?php echo $login_data['email'] ?>" class="my-profile__field" id="profile-last-name">

                        <label for="profile-title" class="my-profile__label">Address</label>
                        <input type="text" value="<?php echo $login_data['address'] ?>" class="my-profile__field" id="profile-title">

                        <label for="profile-number" class="my-profile__label">Phone Number</label>
                        <input type="text" value="<?php echo $login_data['phone'] ?>" class="my-profile__field" id="profile-number">
