...
<header class="header header--blue header--top">
		...
		<div class="topbar">
			<ul class="topbar__contact">
				...
				<li><span class="ion-ios-email-outline topbar__icon"></span><a href="info@tanah.com" class="topbar__link">info@tanah.com</a></li>
			</ul><!-- .topbar__contact -->

			<ul class="topbar__user">
				<span class="ion-ios-person-outline topbar__user-icon"></span>
				<li><a href="<?php echo base_url('login') ?>" class="topbar__link">Sign In</a></li>
...
<section class="main-slider">
	<div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="realand-slider-1" data-source="gallery" style="margin:0px auto;background:rgba(0,0,0,0.5);padding:0px;margin-top:0px;margin-bottom:0px;">
		...
		<div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.6">
			<ul>
				<!-- SLIDE  -->
				<li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url();?>images/revslider/main_slider_1-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url();?>images/revslider/dummy.png" alt="" title="main_slider_1" width="1920" height="820" data-lazyload="<?php echo base_url();?>images/revslider/main_slider_1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
				...
				<!-- SLIDE  -->
				<li data-index="rs-12" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url();?>images/revslider/main_slider_1-2-100x50.jpeg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url();?>images/revslider/dummy.png" alt="" title="Main Slider 1-2" width="1920" height="820" data-lazyload="<?php echo base_url();?>images/revslider/main_slider_1-2.jpeg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
	...
	<?php $this->load->view('content/search'); ?>
	<!-- .main-search -->
</section><!-- .main-slider -->
        ...
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              ...
              <img src="<?php echo base_url();?>images/uploads/real_house_luxury_villa.jpg" alt="Real House Luxury Villa" class="listing__img">
            ...
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">Real House Luxury Villa</a></h3>
      ...
      <div class="col-md-6 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="<?php echo base_url();?>images/uploads/dream_house_take_away.jpg" alt="Dream House Take Away" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">House Take Away</a></h3>
                  <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
                </div><!-- .listing__header-primary -->
                <p class="listing__price">$2,285,500</p>
              </div><!-- .listing__header -->
      ...
      <div class="col-md-6 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="<?php echo base_url();?>images/uploads/weston_hightpointe_place.jpg" alt="Weston Hightpointe Place" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">Weston Hightpointe Place</a></h3>
                  <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
                </div><!-- .listing__header-primary -->
                <p class="listing__price">$2,285,500</p>
              </div><!-- .listing__header -->
      ...
      <div class="col-md-6 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="<?php echo base_url();?>images/uploads/sunhouse_apartment_c21.jpg" alt="Sunhouse Apartment C21" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">Sunhouse Apartment C21</a></h3>
                  <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
                </div><!-- .listing__header-primary -->
                <p class="listing__price">$2,285,500</p>
              </div><!-- .listing__header -->
      ...
      <div class="col-md-6 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="<?php echo base_url();?>images/uploads/castalia_shibakoen.jpg" alt="Castalia Shibakoen" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">Castalia Shibakoen</a></h3>
                  <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
                </div><!-- .listing__header-primary -->
                <p class="listing__price">$2,285,500</p>
              </div><!-- .listing__header -->
      ...
      <div class="col-md-6 item-grid__container">
        <div class="listing">
          <div class="item-grid__image-container">
            <a href="single_property_1.html">
              <div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
              <img src="<?php echo base_url();?>images/uploads/residia_nishi_azabu.jpg" alt="Residia Nishi Azabu" class="listing__img">
              <span class="listing__favorite"><i class="fa fa-heart-o" aria-hidden="true"></i></span>
            </a>
          </div><!-- .item-grid__image-container -->
          ...
          <div class="item-grid__content-container">
            <div class="listing__content">
              <div class="listing__header">
                <div class="listing__header-primary">
                  <h3 class="listing__title"><a href="single_property_1.html">Residia Nishi Azabu</a></h3>
                  <p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span> 157 West 57th St, 77 - Central Park South, NYC</p>
                </div><!-- .listing__header-primary -->
                <p class="listing__price">$2,285,500</p>
              </div><!-- .listing__header -->
  ...
  <div class="features__overlay">
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
          <div class="feature">
            <img src="<?php echo base_url();?>images/icon_map.png" alt="Map" class="feature__icon">
        ...
        <div class="col-sm-4">
          <div class="feature">
            <img src="<?php echo base_url();?>images/icon_search.png" alt="Search" class="feature__icon">
        ...
        <div class="col-sm-4">
          <div class="feature">
            <img src="<?php echo base_url();?>images/icon_negotiation.png" alt="Negotiation" class="feature__icon">
...
<?php $this->load->view('content/page-loader') ?>
<!-- JS Files -->
