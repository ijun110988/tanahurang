            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="sign-up__main">
                        <form action="sign_up.html" class="sign-up__form is-visible" id="log-in">
                        ...
                        <form action="" method="post" class="sign-up__form" id="sign-up">
                            <label for="sign-up-name" class="sign-up__label">Name</label>
                            <input type="text" class="sign-up__field" id="sign-up-name" name="member_fullname" placeholder="Enter your full name">
