            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="sign-up__header">
                        <h1 class="sign-up__textcontent">Sign In</h1>
                    </div><!-- .sign-up__header -->

                    <div class="sign-up__main">
					
					<div class="sign-up__main">
                        <form action="<?php echo base_url('as_member/login');?>" method="post" class="sign-up__form is-visible" id="log-in">
                            ...
                            <button type="submit" class="sign-up__submit" value="Login">Sign In</button>
