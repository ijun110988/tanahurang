    ...
    <div class="container">
        ...
        <div class="submit-property__container">
            <div class="row">
                ...
                <form action="submit_property.html">
                    <div class="col-md-9">
                        <div class="submit-property__block">
							...
							<div class="row">
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        ...
                                        <input type="text" class="submit-property__field" id="property-title" placeholder="Title"
                            ...
                            <div class="submit-property__group">
                                ...
                                <input type="text" name="title" class="submit-property__field" id="property-title" placeholder="Title" required>
                            </div><!-- .submit-property__group -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        ...
                                        <select class="ht-field" id="property-type" required>
                                ...
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        ...
                                        <select class="ht-field" id="property-offer" required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="submit-property__group">
                                        ...
                                        <input type="text" class="submit-property__field" id="property-price" required>
